    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                ...
                // Toast.makeText(MessageActivity.this, "Single Click on position :"+position,
                //   Toast.LENGTH_SHORT).show();
                CharSequence optn[] = new CharSequence[] {"delete"};
                AlertDialog.Builder builder = new AlertDialog.Builder(MessageActivity.this);
                builder.setTitle("Select Operation");
                builder.setItems(optn, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        if(i==0)
                        {
                            Toast.makeText(getApplicationContext(), "Next update mein pakka;)",Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onLongClick(final View view, final int position) {
                ...
                //Toast.makeText(MessageActivity.this, "Long press on position :"+position, Toast.LENGTH_LONG).show();
            }
        }));
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(MessageActivity.this, "Image Clicked",
